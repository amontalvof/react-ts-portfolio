export const experience = [
    ...
    },
    {
        ...
        description:
            'Specialized in web development and database administration using a variety of languages and technologies. HTML5, CSS3, JavaScript, and JQuery for the front-end development, and Java, Spring Boot, and Microsoft SQL Server for the backend. Developed the TelPub web application that allowed the ETECSA employees to manage the data generated by the Public Telephone department and increased company efficiency and productivity by 80%.',
    },
];
